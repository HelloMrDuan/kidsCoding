...
const PROJECT_COMPLETION_COPY: Record<string, ProjectCompletionCopy> = {
  'lesson-03-forest-story': {
    summary: '小狐狸已经会走上舞台，还会打招呼了。先回看作品，再继续下一课。',
  ...
  'lesson-06-meadow-story': {
    summary: '这次，小动物从森林走到草地，完成了一次小旅行。先回看作品，再继续下一课。',
  ...
  'lesson-09-garden-story': {
    summary: '现在，你的故事已经会回应你的点击了。先回看作品，再继续下一课。',
    spotlightTag: '第三个完整作品',
    spotlightTitle: '你做出了一个完整作品',
    spotlightBody:
      '这次，你做出了会回应你的点击的互动故事。现在可以继续第四单元，让两个角色一起完成启蒙毕业作品。',
  },
  'lesson-12-graduation-show': {
    summary: '这次，两个动物朋友一起完成了一个完整故事。先回看作品，再看看高阶创作阶段。',
    spotlightTag: '启蒙毕业作品',
    spotlightTitle: '你做出了一个完整作品',
    spotlightBody:
