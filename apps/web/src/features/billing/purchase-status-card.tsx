    ...
    return (
      <section className="space-y-4 rounded-[1.5rem] bg-emerald-50 p-5 text-emerald-900">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link
            className="inline-flex items-center justify-center rounded-full bg-emerald-600 px-5 py-3 text-sm font-bold text-white"
            href="/learn/map"
          >
            去学习地图
          </Link>
          <Link
            className="inline-flex items-center justify-center rounded-full border border-emerald-200 px-5 py-3 text-sm font-bold text-emerald-900"
  ...
  if (timedOut) {
    return (
      <section className="space-y-4 rounded-[1.5rem] bg-sky-50 p-5 text-sky-950">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            className="inline-flex items-center justify-center rounded-full bg-sky-600 px-5 py-3 text-sm font-bold text-white"
          ...
          <Link
            className="inline-flex items-center justify-center rounded-full border border-sky-200 px-5 py-3 text-sm font-bold text-sky-900"
            href="/parent/overview"
          >
            返回家长页
          </Link>
